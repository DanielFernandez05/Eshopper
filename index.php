...
<?php
 ...
 foreach($filas as $value){
  ...
  $BDProductos = array( 
    ...
    array(100, 350, 200, 420, 250,350,2000,),                             //El Precio
  ...
  $BDAlmacen = array( 
    ...
    array(0,10, 5,15, 3,19,2)); //Las Existencias
...
<head>
    ...
    <meta name="Fernandez Castañeda Christian Daniel" content="">
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> +52-624-159-1944</a></li> <li><a href="#"><i class="fa fa-envelope"></i>- atencionclientes@gmail.com</a></li>
								<li><a href="#"><i class="fa fa-phone"></i> +52 624 159 1944</a></li>
		...
		<div class="header-middle"><!--header-middle-->
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-8">
						Creado Por: Fernandez Castañeda Christian Daniel
							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											...
											$img = $BDProductos[0][$i];
											?>
											<img src="images/home/<?php echo $img; ?>.jpg" alt= " " width= "210" heigth="180"/>
										<h2>
